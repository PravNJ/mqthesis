...
This chapter presents an overview of the raw data used in this work, the challenges faced when working with higher dimensional data, strategies that were used to overcome these challenges, notes on data re-sampling and spectra region selection, and how a recent data set of emission-line stars aided the development of the methods presented in this work.
